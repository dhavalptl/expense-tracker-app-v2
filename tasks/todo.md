...
| 05 | [History search & filters](.scratch/expense-tracker-core/issues/05-history-filters.md) | 04 | ready |
| 06 | [Monthly budget](.scratch/expense-tracker-core/issues/06-monthly-budget.md) | 04 | ready |
...
**Frontier now:** `05` and `06` (can run in parallel).
