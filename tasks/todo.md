...
| 02 | [Email auth + shell](.scratch/expense-tracker-core/issues/02-email-auth-shell.md) | 01 | ready |
| 03 | [Categories seeds + CRUD](.scratch/expense-tracker-core/issues/03-categories.md) | 02 | blocked |
